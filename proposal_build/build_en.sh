#!/usr/bin/env bash
# =================================================================
# Build script: draft_proposal_skripsi_en.md -> draft_proposal_skripsi_en.pdf
# English edition. Usage:  ./build_en.sh
# =================================================================
set -euo pipefail
...
BODY="$SCRIPT_DIR/body_en.md"
META="$SCRIPT_DIR/metadata_en.yaml"
TEMPLATE="$SCRIPT_DIR/template_en.tex"
OUT="$SCRIPT_DIR/draft_proposal_skripsi_en.pdf"
...
# pandoc sees the chapter headings as the top level, then strip manual
# numbering prefixes from headings (e.g. "## CHAPTER I INTRODUCTION" -> "## INTRODUCTION",
